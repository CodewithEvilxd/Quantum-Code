# Test Repositories for Quantum Code Integration Testing

## Overview

This directory contains a curated collection of **intentionally buggy** test repositories designed to comprehensively validate Quantum Code's AI-powered code analysis capabilities across all workflows: `codereview`, `chat`, `compare`, and `debate`.

Each repository contains real-world code patterns with known issues spanning security vulnerabilities, concurrency bugs, architectural flaws, and code quality problems. These repositories enable objective, measurable testing of Quantum Code's ability to detect bugs, explain architecture, compare solutions, and facilitate technical debates.
...
2. **Workflow Validation**: Test all Quantum Code workflows (codereview, chat, compare, debate)
...
⚠️ **Warning**: All code in these repositories is **intentionally vulnerable and buggy**. Never use these patterns in production code. These repositories exist solely for testing Quantum Code's analysis capabilities.

## License

These test repositories are part of the Quantum Code project and are provided for testing purposes only.
