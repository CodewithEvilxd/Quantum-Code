...
class TestMCPMonitorDecorator:
    ...
    async def test_decorator_without_parentheses(self):
        ...
        with patch("quantum_code.utils.mcp_decorator.log_mcp_interaction") as mock_log:
    ...
    async def test_decorator_extracts_thread_id(self):
        ...
        with (
            patch("quantum_code.utils.mcp_decorator.log_mcp_interaction") as mock_log,
            patch("quantum_code.utils.mcp_decorator.set_request_context") as mock_set_context,
        ):
    ...
    async def test_decorator_stacking_order(self):
        ...
        with patch("quantum_code.utils.mcp_decorator.log_mcp_interaction"):
            await my_tool(1)
