...
from quantum_code.utils.paths import resolve_path
...
class TestBinaryFileDetection:
    ...
    def test_text_file_not_binary(self, temp_files):
        ...
        from quantum_code.utils.files import is_binary_file
...
class TestEmbedFilesForExpert:
    ...
    def test_embed_files_basic(self, temp_project):
        ...
        from quantum_code.utils.files import embed_files_for_expert
