...
from quantum_code.utils.consolidation import (
...
class TestConsolidateModelResults:
    ...
    async def test_consolidate_multiple_models(self):
        ...
        with patch("quantum_code.utils.consolidation.execute_single", new_callable=AsyncMock) as mock_execute:
    ...
    async def test_consolidation_failure_fallback(self):
        ...
        with patch("quantum_code.models.litellm_client.LiteLLMClient.execute", new_callable=AsyncMock) as mock_llm:
...
class TestSortIssuesByLocation:
    ...
    def test_sort_issues_by_location(self):
        ...
        from quantum_code.utils.consolidation import _sort_issues_by_location
