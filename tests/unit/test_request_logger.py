...
from quantum_code.utils.request_logger import log_llm_interaction
...
class TestLogLLMInteraction:
    ...
    def test_log_llm_interaction_creates_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir, patch("quantum_code.utils.log_helpers.LOGS_DIR", Path(tmpdir)):
    ...
    def test_log_llm_interaction_handles_write_errors(self):
        ...
        with patch("quantum_code.utils.log_helpers.LOGS_DIR", Path("/invalid/nonexistent/dir")):
