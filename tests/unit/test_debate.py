...
from quantum_code.schemas.debate import DebateRequest, DebateResponse
from quantum_code.tools.debate import _format_debate_prompt, debate_impl
...
class TestDebateImpl:
    ...
    async def test_both_steps_succeed(self):
        ...
        with patch("quantum_code.tools.debate.execute_parallel", side_effect=mock_execute_parallel):
