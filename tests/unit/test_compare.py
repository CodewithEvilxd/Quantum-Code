...
from quantum_code.memory.store import get_messages, make_model_thread_id
from quantum_code.schemas.base import ModelResponse, ModelResponseMetadata, MultiToolRequest, MultiToolResponse
...
class TestCompareImpl:
    ...
    async def test_partial_failure(self):
        ...
        with patch("quantum_code.utils.llm_runner._litellm_client.execute", new_callable=AsyncMock) as mock_call_async:
