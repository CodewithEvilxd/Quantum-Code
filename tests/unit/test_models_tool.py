...
class TestModelsImpl:
    ...
    async def test_models_impl_returns_model_list(self, sample_config):
        ...
        with (
            patch("quantum_code.tools.models.ModelResolver") as mock_resolver_class,
            patch("quantum_code.tools.models.validate_model_credentials") as mock_validate,
            patch("quantum_code.tools.models.settings") as mock_settings,
        ):
