...
class TestServerImport:
    ...
    def test_server_imports_successfully(self):
        """Server module imports without errors."""
        try:
            import quantum_code.server  # noqa: F401
...
class TestConfigurationLoading:
    ...
    def test_model_config_loads(self):
        ...
        from quantum_code.models.config import load_models_config
    ...
    def test_prompts_load(self):
        ...
        from quantum_code.prompts import CHAT_PROMPT, CODEREVIEW_PROMPT
