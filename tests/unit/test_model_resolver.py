...
from quantum_code.models.config import ModelConfig, ModelsConfiguration
...
class TestModelResolver:
    ...
    @patch("quantum_code.models.resolver.litellm")
    ...
    def test_get_default(self, resolver):
        ...
        with patch("quantum_code.models.resolver.settings") as mock_settings:
    ...
    def test_model_config_get_provider_from_litellm_db(self):
        ...
        with patch("quantum_code.models.config.litellm") as mock_litellm:
