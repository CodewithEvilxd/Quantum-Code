...
from quantum_code.models.config import (
    ModelConfig,
    ModelsConfiguration,
    get_models_config,
    load_models_config,
...
class TestModelConfig:
    ...
    @patch("quantum_code.models.config.litellm")
...
class TestGetModelsConfig:
    ...
    def test_get_models_config_caching(self):
        ...
        # Reset cache
        import quantum_code.models.config

        quantum_code.models.config._config = None

        with patch("quantum_code.models.config.load_models_config") as mock_load:
