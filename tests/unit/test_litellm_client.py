...
from quantum_code.models.config import ModelConfig, ModelConstraints, ModelsConfiguration
from quantum_code.models.litellm_client import LiteLLMClient
from quantum_code.models.resolver import ModelResolver
from quantum_code.schemas.base import ModelResponse
...
class TestLiteLLMClient:
    ...
    async def test_call_async_success(self, client, mock_llm_response):
        ...
        with (
            patch("quantum_code.models.litellm_client.litellm.aresponses", new_callable=AsyncMock) as mock_completion,
            patch("quantum_code.models.litellm_client.log_llm_interaction"),
    ...
    async def test_call_async_logging(self, client, mock_llm_response):
        ...
        with (
            patch("quantum_code.models.litellm_client.litellm.aresponses", new_callable=AsyncMock) as mock_completion,
            patch("quantum_code.models.litellm_client.log_llm_interaction") as mock_log,
            patch.object(client, "_validate_provider_credentials", return_value=None),
        ):
            mock_completion.return_value = mock_llm_response
    ...
    async def test_credential_validation_azure_missing_key(self, sample_config):
        ...
        with patch("quantum_code.models.litellm_client.settings") as mock_settings:
