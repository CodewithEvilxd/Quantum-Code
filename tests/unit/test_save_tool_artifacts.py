...
from quantum_code.schemas.base import BaseToolRequest, ModelResponse, ModelResponseMetadata
from quantum_code.utils.artifacts import save_tool_artifacts
...
async def test_save_tool_artifacts_success(base_request, success_response):
    ...
    try:
        with patch("quantum_code.utils.artifacts.save_artifact_files", new_callable=AsyncMock) as mock_save:
