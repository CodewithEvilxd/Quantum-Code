#!/usr/bin/env bash
# Code quality checks for Quantum Code
...
echo "====================================="
if $CI_MODE; then
    echo "Quantum Code CI Checks (no auto-fix)"
else
    echo "Quantum Code Code Quality Checks"
fi
echo "====================================="
echo ""
...
uv run vulture quantum_code/ scripts/vulture_whitelist.py --min-confidence 80 --exclude "quantum_code/cli.py"
