#!/usr/bin/env bash
# Verify Quantum Code installation

set -e

echo "Verifying Quantum Code installation..."
...
uv run python -c "from quantum_code.server import mcp; print('✓ Server module loads correctly')" || {
